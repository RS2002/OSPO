...
def main():
    ...
    while True:
        ...
        for t in pbar:
            ...
            worker.update(feedback_table, new_route_table ,new_route_time_table ,new_remaining_time_table ,new_total_travel_time_table, new_detour_table, reward, assignment, order_state, q_ori, (t==args.max_step - 1), j)
        ...
        if j % args.eval_episode == 0 :
            ...
            for t in pbar:
                ...
                worker.update(feedback_table, new_route_table, new_route_time_table, new_remaining_time_table,
                              new_total_travel_time_table, new_detour_table, reward, assignment, order_state, q_ori, (t == args.max_step - 1), j)
                assignment = [x for x in assignment if x is not None]
                demand.pickup(assignment)
                demand.update()
